...
namespace NHS111.Models.Test.Models.Web.Validators
{
    ...
    public class PostCodeFormatValidatorTests
    {
        ...
        {
            Assert.IsFalse(PostCodeFormatValidator<PostcodeViewModel, string>.IsAValidPostcode("1234"));
        }

        [Test]
        public void Is_valid_only_letters_string_returns_false()
        {
            Assert.IsFalse(PostCodeFormatValidator<PostcodeViewModel, string>.IsAValidPostcode("abcdef"));
        }

        [Test]
        public void Is_valid_only_non_alpha_numeric_string_returns_false()
        {
            Assert.IsFalse(PostCodeFormatValidator<PostcodeViewModel, string>.IsAValidPostcode("£$%^^&^"));
        }

        [Test]
        public void Is_valid_contains_non_alpha_numeric_string_returns_false()
        {
            Assert.IsFalse(PostCodeFormatValidator<PostcodeViewModel, string>.IsAValidPostcode("ab $%^ n6$^ ef"));
        }

        [Test]
        public void Is_valid_postcode_string_returns_true()
        {
            Assert.IsTrue(PostCodeFormatValidator<PostcodeViewModel, string>.IsAValidPostcode("SO30 2UN"));
        }
        ...
        {
            Assert.IsTrue(PostCodeFormatValidator<PostcodeViewModel, string>.IsAValidPostcode("So302Un"));
        }
        ...
        {
            Assert.IsFalse(PostCodeFormatValidator<PostcodeViewModel, string>.IsAValidPostcode("So30"));
        }
        ...
        public void Is_valid_all_return_true()
        {
            ...
            var sut = postcodes.Select(PostCodeFormatValidator<PostcodeViewModel, string>.IsAValidPostcode);
