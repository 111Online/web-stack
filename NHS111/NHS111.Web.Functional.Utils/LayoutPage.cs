...
namespace NHS111.Web.Functional.Utils
{
    public class LayoutPage : IScreenshotMaker
    {
        ...
        public T CompareAndVerify<T>(ScreenshotComparisonFailureAction action, T page, string uniqueName) where T : IScreenshotMaker
        {
            ...
            Console.WriteLine("##teamcity[testMetadata testName='{0}' type='artifact' value='NHS111/NHS111.Web.Functional.Tests/bin/DebugScreenshots/{1}']", TestContext.CurrentContext.Test.FullName, CreateScreenshotFilename(uniqueName));
            Console.WriteLine("##teamcity[testMetadata testName='{0}' type='image' value='NHS111/NHS111.Web.Functional.Tests/bin/DebugScreenshots/{1}']", TestContext.CurrentContext.Test.FullName, CreateScreenshotFilename(uniqueName));
