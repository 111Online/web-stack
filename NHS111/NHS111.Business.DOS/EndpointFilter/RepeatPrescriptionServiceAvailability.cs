...
{
    public class RepeatPrescriptionServiceAvailability : ServiceAvailability
    {
        private IServiceAvailabilityProfile _serviceAvailabilityProfile;

        public RepeatPrescriptionServiceAvailability(IServiceAvailabilityProfile serviceAvailabilityProfile,
