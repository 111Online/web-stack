...
using NHS111.Logging.Api.IoC;
using StructureMap;
using WebActivatorEx;
using StructureMapScopeModule = NHS111.Logging.Api.IoC.StructureMapScopeModule;
...
namespace NHS111.Logging.Api.IoC{
    public static class StructuremapMvc {
        ...
        public static void Start() {
            IContainer container = Logging.Api.IoC.IoC.Initialize();
