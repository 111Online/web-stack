        ...
        protected override void Configure()
        {
            Mapper.CreateMap<OutcomeViewModel, EmbeddedData>()
                ...
                .ForMember(dest => dest.DispositionDate,
                    opt => opt.MapFrom(src => src.SurveyLink.DispositionDateTime.Date))
                ...
                .ForMember(dest => dest.LaunchPage, opt => opt.MapFrom(src => src.JourneyId))
                .ForMember(dest => dest.ValidationCallbackOfferd,
                    opt => opt.MapFrom(src => src.SurveyLink.ValidationCallbackOffered))
                .ForMember(dest => dest.ServicesOffered, opt => opt.MapFrom(src => src.SurveyLink.ServiceOptions))
                ...
                .ForMember(dest => dest.RecommendedServiceDosType,
                    opt => opt.MapFrom(src => src.RecommendedService.OnlineDOSServiceType))
