...
namespace NHS111.Models.Models.Web.FromExternalServices
{
    ...
    public class DosCheckCapacitySummaryResult
    {
        ...
        public bool ContainsService(DosService selectedService) {
            return !ResultListEmpty && selectedService != null && (Success.Services.Exists(s => s.Id == selectedService.Id) || Success.Services.Exists(s => s.OnlineDOSServiceType == OnlineDOSServiceType.EncounterReport));
        }
    }
}
