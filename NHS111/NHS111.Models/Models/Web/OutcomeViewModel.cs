    ...
    public class OutcomeViewModel : JourneyViewModel
    {
        ...
        public string DispositionText
        {
            get
            {
                ...
                var dispositionText = !string.IsNullOrEmpty(OutcomeGroup.Text) ? string.Format("{0}You should {1}{2}.", !string.IsNullOrEmpty(reasoningText) ? "<br />" : string.Empty, OutcomeGroup.Text, timeFrameText) : string.Empty;
