...
namespace NHS111.Models.Models.Domain {
    ...
    public class OutcomeGroup : IEquatable<OutcomeGroup>
    {
        ...
        public static OutcomeGroup EmergencyDental = new OutcomeGroup { Id = "SP_Emergency_dental", Text = "Emergency dental treatment centre", DefaultTitle = "Your answers suggest you should go to an emergency dental treatment centre" };
