...
namespace NHS111.Business.Test.Services
{
    ...
    public class ItkDispatcherMapperTest
    {
        ...
        public void InitilaiseConverters()
        {
            ...
            Mapper.AddProfile(new FromITKDispatchRequestToSubmitHaSCToService());
        }

        [Test]
        public void FromITKDispatchRequestToSubmitHaSCToService_ConfiguredCorrectly()
        {
            Mapper.AssertConfigurationIsValid("FromITKDispatchRequestToSubmitHaSCToService");
        }
        ...
        public void Map_ITKDispatchRequest_To_ToSubmitHaSCToService()
        {
            ...
            var result = Mapper.Map<ITKDispatchRequest, SubmitHaSCToService>(dispatchRequest);
