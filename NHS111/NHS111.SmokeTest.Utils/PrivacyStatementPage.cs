...
namespace NHS111.SmokeTest.Utils
{
    ...
    {
        private const string _privacyHeaderText = "Privacy policy";
        private const string _privacyHeaderSelector = "main[id='content'] > div.privacy > h1";
        ...
        [FindsBy(How = How.CssSelector, Using = _privacyHeaderSelector)]
