    ...
    public class DirectLinkingTests : BaseTests
    {
        ...
        public class Validation : BaseTests
        {
            ...
            public void CorrectEDService()
            {
                ...
                var directLink = TestScenarioPart.DirectLinking(Driver, "/question/direct/PW1685MaleAdult/24/Sexual Concerns/AL74HL/?answers=0,2,3,2,2,2,3,3,0,0,2&dossearchdatetime=2021-02-02 12:00");
        ...
        public class RecommendedService : BaseTests
        {
            ...
            {
                var directLink = TestScenarioPart.DirectLinking(Driver, "/question/direct/PW1827MaleAdult/33/Emergency%20Prescription%20111%20online/LS175DT/?answers=0,1,0&dossearchdatetime=2021-02-02 23:30");
