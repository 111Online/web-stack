...
namespace NHS111.Web.Functional.Tests
{
    ...
    public class DirectLinkingTests : BaseTests
    {
        ...
        [TestCase("/question/direct/PW1610MaleAdult/25/Dentalproblems/ls177nz/?answers=1,2,0,0,0,0,2,2&dossearchdatetime=2020-02-01 22:30", "Dx19",  TestName = "DoS SearchTimeDate doesn't break direct link")]
        ...
        public class Validation : BaseTests
        {
            ...
            public void CorrectEDService()
            {
                ...
                var directLink = TestScenarioPart.DirectLinking(Driver, "/question/direct/PW1685MaleAdult/24/Sexual Concerns/AL74HL/?answers=2,3,2,2,2,3,3,0,0,2&dossearchdatetime=2020-02-01 12:00");
