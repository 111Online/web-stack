...
namespace NHS111.Web.Functional.Tests
{
    public class GuidedSearchTests : BaseTests
    {
        ...
        [TestCase(TestScenerioSex.Female, TestScenerioAgeGroups.Adult, "Coldorflusymptoms", "PW1040")]
        [TestCase(TestScenerioSex.Male, TestScenerioAgeGroups.Adult, "Coldorflusymptoms", "PW1042")]
        [TestCase(TestScenerioSex.Female, TestScenerioAgeGroups.Child, "Coldorflusymptoms", "PW1041")]
        [TestCase(TestScenerioSex.Male, TestScenerioAgeGroups.Child, "Coldorflusymptoms", "PW1043")]
        ...
        [TestCase(TestScenerioSex.Female, TestScenerioAgeGroups.Adult, "Hightemperaturewithnoothersymptoms", "PW708")]
        [TestCase(TestScenerioSex.Male, TestScenerioAgeGroups.Adult, "Hightemperaturewithnoothersymptoms", "PW711")]
        [TestCase(TestScenerioSex.Female, TestScenerioAgeGroups.Child, "Hightemperaturewithnoothersymptoms", "PW709")]
        [TestCase(TestScenerioSex.Male, TestScenerioAgeGroups.Child, "Hightemperaturewithnoothersymptoms", "PW712")]
