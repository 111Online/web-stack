...
namespace NHS111.Business.DOS.Test
{
    ...
    public class ServiceAvailabilityTests
    {
        ...
        private ServiceAvailability.ServiceAvailability _serviceAvailability;
        ...
        public void IsOutOfHours_Dispo_And_Time_Frame_In_Hours_Test()
        {
            ...
            _serviceAvailability = new ServiceAvailability.ServiceAvailability(_mockServiceAvailabilityProfile.Object, It.IsAny<DateTime>(), It.IsAny<int>());
